...
public class ExemploStream {
    ...
    public static void main(String[] args) {
        ...
        list.stream()
            .filter(f -> "Desenvolvedor".equals(f.getCargo()))//Pega somente os Desenvolvedores
            .sorted((f1, f2) -> f1.getNome().compareTo(f2.getNome()))// Faz compraração
            //.skip(1)// Pula o elemento. 
            //.limit(2)// Limita o numero de mostragem. 
            .forEach(System.out::println);// Monstra todos. 
    }
}
